...
import LiqudityLockTest from "../LiquidityLock/LiquidityLockTest.js";
...
export default function TokenLock() {
  ...
  const TextFieldFocusActionListener = () => {
    getPrice();
  }
    ...
    <GridContainer justifyContent="center">
      <GridItem xs={12} sm={12} md={8}>
        <Card>
          ...
          <CardBody>
            ...
            <Box sx={{ display: 'flex', alignItems: 'flex-end' }}>
              ...
              <TextField fullWidth id="input-with-sx" value = {tokenstaddr} onFocus={TextFieldFocusActionListener} onChange={(e) => addrChange(e.target.value)} label="Input token address" variant="standard" />
            </Box>
        ...
        <LiqudityLockTest 
          ...
          setParentSymbol={setSymbol} 
          setParentPrice={setPrice} 
          setParentPenalFee={setPenalFee}
          setParentUnlockTime={setUnlockTime}
          setParentModalOpen={setDigOpen}
          parentName={name}
          parentSymbol={symbol}
          parentPrice={price}
          parentPenalFee={penalfee}
          parentUnlocktime={unlocktime}
          parentDigOpen={opendis}
        />
